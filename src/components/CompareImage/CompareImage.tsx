      ...
      {(!leftImage || !rightImage) && (
        <div style={styles.container} position="absolute z-30">
          ...
          <div
            ...
            className={leftLabelContainerClass}
          >
            <div style={styles.leftLabel} className={leftLabelClass}>
              <div style={styles.rightLabelTitle}>
                {leftImage
          ...
          <div
            ...
            className={rightLabelContainerClass}
          >
            <div style={styles.rightLabel} className={rightLabelClass}>
              <div style={styles.rightLabelTitle}>
                {formatMessage(messages.selectEndDate)}
              </div>
            </div>
          </div>
        </div>
...
const messages = defineMessages({
  area: {
    id: 'src.components.CompareImage.area',
    defaultMessage: 'Area',
  },
  selectStartDate: {
    id: 'src.components.CompareImage.selectStartDate',
    defaultMessage: 'Select start date',
  },
  selectEndDate: {
    id: 'src.components.CompareImage.selectEndDate',
